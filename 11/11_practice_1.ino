...
#define PIN_ECHO  4  // sonar sensor ECHO
...
#define _DIST_MAX 380.0   // maximum distance to be measured (unit: mm)
...
void loop() {
  ...
  if(dist_ema <= _TARGET_LOW){
    ...
    long angle = map(dist_ema, _TARGET_LOW, _TARGET_HIGH, _DUTY_MIN, _DUTY_MAX);
