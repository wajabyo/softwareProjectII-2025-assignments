...
{
  unsigned int *ir_val, ret_val;  //sensoredArray, selected
  unsigned int start_time;        //if verbose == 2 then..
  ...
  //allocate n sized array in runtime
  ...
  //quick sort? big-O nlogn in average but n ^ 2 in worst
  ...
  free(ir_val); //no need to use array anymore in this func(need to free).
