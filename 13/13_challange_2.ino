...
#define _DUTY_MIN 100 // servo full clock-wise position (0 degree)
#define _DUTY_NEU 1475 // servo neutral position (90 degree)
#define _DUTY_MAX 2850 // servo full counter-clockwise position (180 degree)

#define _POS_START (_DUTY_MIN + 100)    // servo start position
#define _POS_END   (_DUTY_MAX - 100)    // servo end position

#define _SERVO_SPEED 0.3 // servo speed limit (unit: degree/second) (testcase: 3, 0.3)
#define INTERVAL 35 * (float)20 / _SERVO_SPEED     // servo update interval (unit: msec)
